...
public class CustomAdapater extends BaseAdapter{
    ...
    public CustomAdapater(Context context, List<ItemObject> customizedListView) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            ...
            convertView = layoutinflater.inflate(R.layout.custom_gridview_content, parent, false);
